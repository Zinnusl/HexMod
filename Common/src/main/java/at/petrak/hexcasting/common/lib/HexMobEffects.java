...
public class HexMobEffects {
    ...
    // 1.21: MobEffect#addAttributeModifier takes Holder<Attribute> + ResourceLocation id
    // (not UUID string) + amount + operation.
    public static final MobEffect ENLARGE_GRID = make("enlarge_grid",
        new HexMobEffect(MobEffectCategory.BENEFICIAL, 0xc875ff))
        .addAttributeModifier(HexAttributes.holder(HexAttributes.GRID_ZOOM),
            ResourceLocation.fromNamespaceAndPath(HexAPI.MOD_ID, "effect.enlarge_grid"),
    ...
    public static final MobEffect SHRINK_GRID = make("shrink_grid",
        ...
        .addAttributeModifier(HexAttributes.holder(HexAttributes.GRID_ZOOM),
            ResourceLocation.fromNamespaceAndPath(HexAPI.MOD_ID, "effect.shrink_grid"),
