...
public class AddPerWorldPatternToScrollFunc extends LootItemConditionalFunction {
    public static final MapCodec<AddPerWorldPatternToScrollFunc> CODEC = RecordCodecBuilder.mapCodec(inst ->
        commonFields(inst).apply(inst, AddPerWorldPatternToScrollFunc::new)
    );

    public AddPerWorldPatternToScrollFunc(List<LootItemCondition> conditions) {
        super(conditions);
    }
